...
class SalomonBottomBar extends StatelessWidget {
  ...
  final bool showBackroundColor;

  /// The ripple effect when any item tapped
  final bool showSplashColor;
          ...
          for (final item in items)
            TweenAnimationBuilder<double>(
              ...
              builder: (context, t, _) {
                ...
                return Material(
                  color: showBackroundColor ? Color.lerp(_selectedColor.withOpacity(0.0), _selectedColor.withOpacity(0.1), t) : Colors.transparent,
                  shape: StadiumBorder(),
                  child: InkWell(
                    onTap: () => onTap?.call(items.indexOf(item)),
                    customBorder: StadiumBorder(),
                    focusColor: showSplashColor ? _selectedColor.withOpacity(0.1) : Colors.transparent,
                    highlightColor: showSplashColor ? _selectedColor.withOpacity(0.1) : Colors.transparent,
                    splashColor: showSplashColor ? _selectedColor.withOpacity(0.1) : Colors.transparent,
